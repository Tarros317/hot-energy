...
export const LEAD_FORMS = {
  hero: {
    ...
    form: {
      ...
      bullets: ['Дзвінок за 15 хвилин', 'Гарантія 5 років на акумулятор', 'Доставка по Україні'],
  ...
  battery: {
    ...
    form: {
      ...
      bullets: ['Гарантія 5 років', 'До 4 модулів у паралель', 'Можна дозбирати пізніше'],
